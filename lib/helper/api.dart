...
class Api {
  Future<dynamic> get({required String url,@required String? token}) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
          'There\'s a problem with statues code${response.statusCode}');
    }
  }
  ...
  Future<dynamic> post({required String url, @required dynamic body,@required String? token}) async {
    ...
    http.Response response =
      ...
      return data;
        ...
        throw Exception('there is a problem with statues code ${response.statusCode} and with body${jsonDecode(response.body)}');
      }
  }
